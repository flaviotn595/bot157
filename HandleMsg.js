	...
	// Filter Banned People
        ...
        case 'stiker':
            if ((isMedia || isQuotedImage) && args.length === 0) {
                ...
                .then(() => {
                    ...
                    console.log(`Adesivo processado para ${processTime(t, moment())} Second`)
                })
            } else if (args[0] === 'nobg') {
        ...
        case 'stickergiphy':
            ...
            if (isGiphy) {
                ...
                aruga.sendGiphyAsSticker(from, smallGifUrl).then(() => {
                    aruga.reply(from, 'Aqui está o seu adesivo')
                    console.log(`Adesivo processado para ${processTime(t, moment())} Second`)
        ...
        case 'bc': //untuk broadcast atau promosi
            ...
            for (let idk of chatz) {
                ...
                if (!cvk.isReadOnly) aruga.sendText(idk, `〘 *R I D H O  B C* 〙\n\n${msg}`)
                if (cvk.isReadOnly) aruga.sendText(idk, `〘 *R I D H O  B C* 〙\n\n${msg}`)
            }
